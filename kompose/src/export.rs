...
pub struct ExportCommand {
    ...
    /// make a list from all inputs instead of merging them
    #[arg(long = "as-list")]
    as_list: bool,

    /// Only query a specific field of the configuration.
    /// If '--as-list' option is set, this option would be ignored.
...
impl ExportCommand {
    pub fn run(self, global: GlobalOptions) -> CliResult<()> {
        ...
        let mut program = if self.as_list {
        ...
        program = program_with_field(program, self.field.clone())?;
